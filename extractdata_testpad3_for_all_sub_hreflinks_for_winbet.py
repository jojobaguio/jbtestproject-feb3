...
def test_getwebdata():
	...
	'''
	with open('./datasource/storelinks_hrefonly_winbet.csv', mode='r') as f:
		...
		for i in reader:	
			...
			for a in soup.find_all('a', href=True):
				...
				if any(x in valhref for x in includestr):
					...
					with open('./datasource/storelinks_all_winbet_sublinks.csv', 'a') as the_file1:
						...
						if m:
							getsrch = m.group(1)
							with open("./datasource/all_winbet_hreflinks/"+getsrch+".html", 'a') as the_file:
